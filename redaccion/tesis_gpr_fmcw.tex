...
%============================================================
\chapter{Banco de Pruebas y Caracterización del VCO}
\label{ch:banco}
%============================================================

\section{Banco de pruebas}
\label{sec:banco_fotos}

\textit{[Pendiente: fotos del banco de prueba y del radar armado.]}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{figuras/vco_frecuencia_vs_tension.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{figuras/dac_capturas_osciloscopio.png}
